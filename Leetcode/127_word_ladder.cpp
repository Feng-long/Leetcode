...
{ 
	...
	{
		public: size_t operator()(const state_t& s) const
...
{
public:
	// const reference don't create more memory to store var and don't change the value
	int ladderLength(const string &start, const string &end, const unordered_set<string> &dict)
	{

		queue<state_t> q; unordered_set<state_t> visited;
